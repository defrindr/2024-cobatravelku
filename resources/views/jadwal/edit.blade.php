        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-default">
                    <div class="card-body">
                        <form action="{{ route('jadwal.store', compact('jadwal')) }}" class="form" method="post">
                            @csrf
                            @method('post')
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="nomor_polisi" id="nomor_polisi"
                                            value="{{ old('nomor_polisi') ?? $jadwal->nomor_polisi }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="jenis_mobil" id="nomor_polisi"
                                            value="{{ old('jenis_mobil') ?? $jadwal->jenis_mobil }}">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="1" class="form-control" name="kuota"
                                            id="nomor_polisi" value="{{ old('kuota') ?? $jadwal->kuota }}" readonly>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="50000" class="form-control" name="harga_travel"
                                            id="nomor_polisi" value="{{ old('harga_travel') ?? $jadwal->harga_travel }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="50000" class="form-control" name="harga_barang"
                                            id="nomor_polisi" value="{{ old('harga_barang') ?? $jadwal->harga_barang }}">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="time" class="form-control" name="jam_berangkat" id="nomor_polisi"
                                            value="{{ old('jam_berangkat') ?? $jadwal->jam_berangkat }}">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select name="kota_keberangkatan_id" id="kota_keberangkatan_id" class="form-control"
                                            ...
                                            @foreach ($kotaKeberangkatans as $item)
                                                <option @if ($item->id == (old('kota_keberangkatan_id') ?? $jadwal->kota_keberangkatan_id)) selected @endif
                                                    value="{{ $item->id }}">
                                                    {{ $item->nama }}
                                                </option>
                                            @endforeach
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="kota_tujuan_id" id="kota_tujuan_id" class="form-control" required>
                                            ...
                                            @foreach ($kotaTujuans as $item)
                                                <option @if ($item->id == (old('kota_tujuan_id') ?? $jadwal->kota_tujuan_id)) selected @endif
                                                    value="{{ $item->id }}">
                                                    {{ $item->nama }}
                                                </option>
                                            @endforeach
