<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item has-treeview">
            ...
            <a href="{{ route('kota_keberangkatan.index') }}" class="nav-link {{ Request::is('kota_keberangkatan*') ? 'active' : '' }}">
                <i class="far fa-circle nav-icon"></i>
                <p>Kota Keberangkatan</p>
            </a>
        </li>
                <li class="nav-item {{ Request::is('kota_tujuan*') ? 'menu-open' : '' }}">
            <a href="{{ route('kota_tujuan.index') }}" class="nav-link {{ Request::is('kota_tujuan*') ? 'active' : '' }}">
                <i class="far fa-circle nav-icon"></i>
                <p>Kota Tujuan</p>
            </a>
        </li>
